...
#define MCP4728_I2CADDR 0x64 ///< MCP4728 default i2c address
#define I2C_SDA 14
#define I2C_SCL 15
...
int setChannelValue(MCP4728_channel_t channel, uint16_t new_value,
                    MCP4728_vref_t new_vref,
                    MCP4728_gain_t new_gain,
                    MCP4728_pd_mode_t new_pd_mode,
                    bool udac);

int fastWrite(uint16_t channel_a_value, uint16_t channel_b_value,
